...
public class HadoopSwitch<T>
{
	...
	protected T doSwitch( int classifierID, EObject theEObject )
	{
		switch ( classifierID )
		{
			...
			case HadoopPackage.ZOO_KEEPER_SERVER :
			{
				...
				if ( result == null )
					result = caseServer( zooKeeperServer );
				if ( result == null )
					result = caseZNode( zooKeeperServer );
				if ( result == null )
					result = defaultCase( theEObject );
				return result;
			}
	 ...
	 * <em>HDFS Server</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Servers</em>'. <!-- begin-user-doc --> This implementation returns
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Zoo Keeper Server</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>ZNode</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
