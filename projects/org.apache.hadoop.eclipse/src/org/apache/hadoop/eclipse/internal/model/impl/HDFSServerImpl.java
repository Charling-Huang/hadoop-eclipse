 ...
 * <em><b>HDFS Server</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.HDFSServerImpl#isLoaded
 * <em>Loaded</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.HDFSServerImpl#getOperationURIs
 * <em>Operation UR Is</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.HDFSServerImpl#getUserId
 * <em>User Id</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.HDFSServerImpl#getGroupIds
 * <em>Group Ids</em>}</li>
 * </ul>
 * </p>
 *
...
public class HDFSServerImpl extends ServerImpl implements HDFSServer
{
	...
	/**
	 * The cached value of the '{@link #getOperationURIs()
	 * <em>Operation UR Is</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getUserId() <em>User Id</em>}'
	...
	/**
	 * The cached value of the '{@link #getUserId() <em>User Id</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getUserId()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getGroupIds() <em>Group Ids</em>}'
	...
	public void setLoaded( boolean newLoaded )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.HDFS_SERVER__LOADED,
					oldLoaded,
					loaded ) );
	}
	...
	public EList<String> getOperationURIs( )
	{
		...
		{
			operationURIs = new EDataTypeUniqueEList<String>( String.class,
					this,
					HadoopPackage.HDFS_SERVER__OPERATION_UR_IS );
		}
	...
	public void setUserId( String newUserId )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.HDFS_SERVER__USER_ID,
					oldUserId,
					userId ) );
	}
	...
	public EList<String> getGroupIds( )
	{
		if ( groupIds == null )
		{
			groupIds = new EDataTypeUniqueEList<String>( String.class,
					this,
					HadoopPackage.HDFS_SERVER__GROUP_IDS );
		}
		return groupIds;
	}
	...
	public boolean eIsSet( int featureID )
	{
		switch ( featureID )
		{
			...
			case HadoopPackage.HDFS_SERVER__USER_ID :
				return USER_ID_EDEFAULT == null ? userId != null
						: !USER_ID_EDEFAULT.equals( userId );
			case HadoopPackage.HDFS_SERVER__GROUP_IDS :
