...
public class HadoopPackageImpl extends EPackageImpl implements HadoopPackage
{
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link HadoopPackage#eINSTANCE} when
	...
	{
		if ( isInited )
			return (HadoopPackage) EPackage.Registry.INSTANCE
					.getEPackage( HadoopPackage.eNS_URI );

		// Obtain or create and register package
		HadoopPackageImpl theHadoopPackage = (HadoopPackageImpl) ( EPackage.Registry.INSTANCE
				.get( eNS_URI ) instanceof HadoopPackageImpl
						? EPackage.Registry.INSTANCE.get( eNS_URI )
						: new HadoopPackageImpl( ) );
		...
		EPackage.Registry.INSTANCE.put( HadoopPackage.eNS_URI,
				theHadoopPackage );
	...
	public void initializePackageContents( )
	{
		...
		initEClass( hdfsServerEClass,
				HDFSServer.class,
				"HDFSServer",
				!IS_ABSTRACT,
				!IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS );
		initEAttribute( getHDFSServer_Loaded( ),
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getHDFSServer_OperationURIs( ),
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getHDFSServer_UserId( ),
				ecorePackage.getEString( ),
				"userId",
				null,
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getHDFSServer_GroupIds( ),
				ecorePackage.getEString( ),
				"groupIds",
				null,
				0,
		...
		initEClass( serversEClass,
				Servers.class,
				"Servers",
				!IS_ABSTRACT,
				!IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS );
		initEReference( getServers_HdfsServers( ),
				this.getHDFSServer( ),
				null,
				"hdfsServers",
				null,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getServers_Version( ),
				ecorePackage.getEString( ),
				"version",
				"1.0.0.0",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEReference( getServers_ZookeeperServers( ),
				this.getZooKeeperServer( ),
				null,
				"zookeeperServers",
				null,
				0,
		...
		initEClass( serverEClass,
				Server.class,
				"Server",
				IS_ABSTRACT,
				!IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS );
		initEAttribute( getServer_Name( ),
				ecorePackage.getEString( ),
				"name",
				"",
				0,
		...
		initEAttribute( getServer_Uri( ),
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getServer_StatusCode( ),
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getServer_StatusMessage( ),
				ecorePackage.getEString( ),
				"statusMessage",
				null,
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getServer_LastAccessed( ),
		...
		initEClass( zooKeeperServerEClass,
		...
		initEClass( zNodeEClass,
				ZNode.class,
				"ZNode",
				!IS_ABSTRACT,
				!IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS );
		initEReference( getZNode_Children( ),
				this.getZNode( ),
				null,
				"children",
				null,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_LastRefresh( ),
				ecorePackage.getELong( ),
				"lastRefresh",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_Refreshing( ),
				ecorePackage.getEBoolean( ),
				"refreshing",
				null,
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_Ephermeral( ),
				ecorePackage.getEBoolean( ),
				"ephermeral",
				null,
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_CreationId( ),
				ecorePackage.getELong( ),
				"creationId",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_ModifiedId( ),
				ecorePackage.getELong( ),
				"modifiedId",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_CreationTime( ),
				ecorePackage.getELong( ),
				"creationTime",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_ModifiedTime( ),
				ecorePackage.getELong( ),
				"modifiedTime",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_Version( ),
				ecorePackage.getEInt( ),
				"version",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_ChildrenVersion( ),
				ecorePackage.getEInt( ),
				"childrenVersion",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_AclVersion( ),
				ecorePackage.getEInt( ),
				"aclVersion",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_EphermalOwnerSessionId( ),
				ecorePackage.getELong( ),
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_DataLength( ),
				ecorePackage.getEInt( ),
				"dataLength",
				"-1",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_ChildrenCount( ),
				ecorePackage.getEInt( ),
				"childrenCount",
				"0",
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEReference( getZNode_Parent( ),
				this.getZNode( ),
				null,
				"parent",
				null,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_NodeName( ),
				ecorePackage.getEString( ),
				"nodeName",
				null,
				0,
				...
				!IS_DERIVED,
				IS_ORDERED );
		initEAttribute( getZNode_Sequential( ),
				ecorePackage.getEBoolean( ),
				"sequential",
				null,
				0,
