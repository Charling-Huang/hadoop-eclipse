 ...
 * <ul>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getChildren
 * <em>Children</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getLastRefresh
 * <em>Last Refresh</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#isRefreshing
 * <em>Refreshing</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#isEphermeral
 * <em>Ephermeral</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getCreationId
 * <em>Creation Id</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getModifiedId
 * <em>Modified Id</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getCreationTime
 * <em>Creation Time</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getModifiedTime
 * <em>Modified Time</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getVersion
 * <em>Version</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getChildrenVersion
 * <em>Children Version</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getAclVersion
 * <em>Acl Version</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getEphermalOwnerSessionId
 * <em>Ephermal Owner Session Id</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getDataLength
 * <em>Data Length</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getChildrenCount
 * <em>Children Count</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getParent
 * <em>Parent</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#getNodeName
 * <em>Node Name</em>}</li>
 * <li>
 * {@link org.apache.hadoop.eclipse.internal.model.impl.ZooKeeperServerImpl#isSequential
 * <em>Sequential</em>}</li>
 * </ul>
 * </p>
 *
...
public class ZooKeeperServerImpl extends ServerImpl implements ZooKeeperServer
{
	...
	public EList<ZNode> getChildren( )
	{
		if ( children == null )
		{
			children = new EObjectContainmentEList<ZNode>( ZNode.class,
					this,
					HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN );
		}
		return children;
	}
	...
	public void setLastRefresh( long newLastRefresh )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__LAST_REFRESH,
					oldLastRefresh,
					lastRefresh ) );
	}
	...
	public void setRefreshing( boolean newRefreshing )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__REFRESHING,
					oldRefreshing,
					refreshing ) );
	}
	...
	public void setEphermeral( boolean newEphermeral )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__EPHERMERAL,
					oldEphermeral,
					ephermeral ) );
	}
	...
	public void setCreationId( long newCreationId )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__CREATION_ID,
					oldCreationId,
					creationId ) );
	}
	...
	public void setModifiedId( long newModifiedId )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__MODIFIED_ID,
					oldModifiedId,
					modifiedId ) );
	}
	...
	public void setCreationTime( long newCreationTime )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__CREATION_TIME,
					oldCreationTime,
					creationTime ) );
	}
	...
	public void setModifiedTime( long newModifiedTime )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__MODIFIED_TIME,
					oldModifiedTime,
					modifiedTime ) );
	}
	...
	public void setVersion( int newVersion )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__VERSION,
					oldVersion,
					version ) );
	}
	...
	public void setChildrenVersion( int newChildrenVersion )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN_VERSION,
					oldChildrenVersion,
					childrenVersion ) );
	}
	...
	public void setAclVersion( int newAclVersion )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__ACL_VERSION,
					oldAclVersion,
					aclVersion ) );
	}
	...
	public void setEphermalOwnerSessionId( long newEphermalOwnerSessionId )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__EPHERMAL_OWNER_SESSION_ID,
	...
	public void setDataLength( int newDataLength )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__DATA_LENGTH,
					oldDataLength,
					dataLength ) );
	}
	...
	public void setChildrenCount( int newChildrenCount )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN_COUNT,
					oldChildrenCount,
					childrenCount ) );
	}
			...
			if ( parent != oldParent )
			{
				if ( eNotificationRequired( ) )
					eNotify( new ENotificationImpl( this,
							...
							HadoopPackage.ZOO_KEEPER_SERVER__PARENT,
							oldParent,
							parent ) );
			}
		}
	...
	public void setNodeName( String newNodeName )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__NODE_NAME,
					oldNodeName,
					nodeName ) );
	}
	...
	public void setSequential( boolean newSequential )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					HadoopPackage.ZOO_KEEPER_SERVER__SEQUENTIAL,
					oldSequential,
					sequential ) );
	}
			...
			Class<?> baseClass )
	{
		if ( baseClass == ZNode.class )
		{
			...
			{
				case HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN :
					return HadoopPackage.ZNODE__CHILDREN;
				case HadoopPackage.ZOO_KEEPER_SERVER__LAST_REFRESH :
					return HadoopPackage.ZNODE__LAST_REFRESH;
				case HadoopPackage.ZOO_KEEPER_SERVER__REFRESHING :
					return HadoopPackage.ZNODE__REFRESHING;
				case HadoopPackage.ZOO_KEEPER_SERVER__EPHERMERAL :
					return HadoopPackage.ZNODE__EPHERMERAL;
				case HadoopPackage.ZOO_KEEPER_SERVER__CREATION_ID :
					return HadoopPackage.ZNODE__CREATION_ID;
				case HadoopPackage.ZOO_KEEPER_SERVER__MODIFIED_ID :
					return HadoopPackage.ZNODE__MODIFIED_ID;
				case HadoopPackage.ZOO_KEEPER_SERVER__CREATION_TIME :
					return HadoopPackage.ZNODE__CREATION_TIME;
				case HadoopPackage.ZOO_KEEPER_SERVER__MODIFIED_TIME :
					return HadoopPackage.ZNODE__MODIFIED_TIME;
				case HadoopPackage.ZOO_KEEPER_SERVER__VERSION :
					return HadoopPackage.ZNODE__VERSION;
				case HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN_VERSION :
					return HadoopPackage.ZNODE__CHILDREN_VERSION;
				case HadoopPackage.ZOO_KEEPER_SERVER__ACL_VERSION :
					return HadoopPackage.ZNODE__ACL_VERSION;
				case HadoopPackage.ZOO_KEEPER_SERVER__EPHERMAL_OWNER_SESSION_ID :
					return HadoopPackage.ZNODE__EPHERMAL_OWNER_SESSION_ID;
				case HadoopPackage.ZOO_KEEPER_SERVER__DATA_LENGTH :
					return HadoopPackage.ZNODE__DATA_LENGTH;
				case HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN_COUNT :
					return HadoopPackage.ZNODE__CHILDREN_COUNT;
				case HadoopPackage.ZOO_KEEPER_SERVER__PARENT :
					return HadoopPackage.ZNODE__PARENT;
				case HadoopPackage.ZOO_KEEPER_SERVER__NODE_NAME :
					return HadoopPackage.ZNODE__NODE_NAME;
				case HadoopPackage.ZOO_KEEPER_SERVER__SEQUENTIAL :
					return HadoopPackage.ZNODE__SEQUENTIAL;
				default :
					return -1;
			}
		}
		...
		if ( baseClass == ZNode.class )
		{
			switch ( baseFeatureID )
			{
				case HadoopPackage.ZNODE__CHILDREN :
					return HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN;
				case HadoopPackage.ZNODE__LAST_REFRESH :
					return HadoopPackage.ZOO_KEEPER_SERVER__LAST_REFRESH;
				case HadoopPackage.ZNODE__REFRESHING :
					return HadoopPackage.ZOO_KEEPER_SERVER__REFRESHING;
				case HadoopPackage.ZNODE__EPHERMERAL :
					return HadoopPackage.ZOO_KEEPER_SERVER__EPHERMERAL;
				case HadoopPackage.ZNODE__CREATION_ID :
					return HadoopPackage.ZOO_KEEPER_SERVER__CREATION_ID;
				case HadoopPackage.ZNODE__MODIFIED_ID :
					return HadoopPackage.ZOO_KEEPER_SERVER__MODIFIED_ID;
				case HadoopPackage.ZNODE__CREATION_TIME :
					return HadoopPackage.ZOO_KEEPER_SERVER__CREATION_TIME;
				case HadoopPackage.ZNODE__MODIFIED_TIME :
					return HadoopPackage.ZOO_KEEPER_SERVER__MODIFIED_TIME;
				case HadoopPackage.ZNODE__VERSION :
					return HadoopPackage.ZOO_KEEPER_SERVER__VERSION;
				case HadoopPackage.ZNODE__CHILDREN_VERSION :
					return HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN_VERSION;
				case HadoopPackage.ZNODE__ACL_VERSION :
					return HadoopPackage.ZOO_KEEPER_SERVER__ACL_VERSION;
				case HadoopPackage.ZNODE__EPHERMAL_OWNER_SESSION_ID :
					return HadoopPackage.ZOO_KEEPER_SERVER__EPHERMAL_OWNER_SESSION_ID;
				case HadoopPackage.ZNODE__DATA_LENGTH :
					return HadoopPackage.ZOO_KEEPER_SERVER__DATA_LENGTH;
				case HadoopPackage.ZNODE__CHILDREN_COUNT :
					return HadoopPackage.ZOO_KEEPER_SERVER__CHILDREN_COUNT;
				case HadoopPackage.ZNODE__PARENT :
					return HadoopPackage.ZOO_KEEPER_SERVER__PARENT;
				case HadoopPackage.ZNODE__NODE_NAME :
					return HadoopPackage.ZOO_KEEPER_SERVER__NODE_NAME;
				case HadoopPackage.ZNODE__SEQUENTIAL :
					return HadoopPackage.ZOO_KEEPER_SERVER__SEQUENTIAL;
				default :
					return -1;
			}
		}
