...
public class HadoopFactoryImpl extends EFactoryImpl implements HadoopFactory
{
	...
	public static HadoopFactory init( )
	{
		try
		{
			HadoopFactory theHadoopFactory = (HadoopFactory) EPackage.Registry.INSTANCE
					.getEFactory( "http://hadoop/1.0" );
	 ...
	 * @generated
	 */
	public ServerStatus createServerStatusFromString( EDataType eDataType,
			String initialValue )
	{
	 ...
	 * @generated
	 */
	public String convertServerStatusToString( EDataType eDataType,
